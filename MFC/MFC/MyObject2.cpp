...
const struct CRuntimeClass CMyObject2::classCMyObject2 =
{ "CMyObject2", sizeof(CMyObject2), 0xffff, NULL, NULL, NULL };

CRuntimeClass* CMyObject2::GetRuntimeClass() const
{
	return _RUNTIME_CLASS(CMyObject2);
}

#ifdef _AFXDLL
CRuntimeClass* PASCAL CMyObject2::_GetBaseClass()
{
	return NULL;
}
CRuntimeClass* PASCAL CMyObject2::GetThisClass()
{
	return _RUNTIME_CLASS(CMyObject2);
}
#endif

BOOL CMyObject2::IsKindOf(const CRuntimeClass* pClass) const
{
	ENSURE(this != NULL);
	// it better be in valid memory, at least for CObject size
	ASSERT(AfxIsValidAddress(this, sizeof(CMyObject2)));
...
void CMyObject2::AssertValid() const
{
	ASSERT(this != NULL);
}

void CMyObject2::Dump(CDumpContext& dc) const
{
...
BOOL CMyObject2::IsSerializable() const
{
