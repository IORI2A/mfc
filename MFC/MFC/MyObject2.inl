...
#ifndef MYOBJECT2_H_TEMPLATE_INCLUDE_GUARD
#define MYOBJECT2_H_TEMPLATE_INCLUDE_GUARD
...
#endif //MYOBJECT2_H_TEMPLATE_INCLUDE_GUARD

#ifndef MYOBJECT2_INL_MANAGED_INIT_INCLUDE_GUARD
#define MYOBJECT2_INL_MANAGED_INIT_INCLUDE_GUARD
...
//}
#endif  // MYOBJECT2_INL_MANAGED_INIT_INCLUDE_GUARD
...
// CMyObject2
_AFX_INLINE CMyObject2::CMyObject2()
{ }
_AFX_INLINE CMyObject2::~CMyObject2()
{ }
_AFX_INLINE void CMyObject2::Serialize(CArchive&)
{ /* CMyObject2 does not serialize anything by default */
}
_AFX_INLINE void* PASCAL CMyObject2::operator new(size_t, void* p)
{
	return p;
}
#ifndef _DEBUG
// _DEBUG versions in afxmem.cpp
_AFX_INLINE void PASCAL CMyObject2::operator delete(void* p)
{
	::operator delete(p);
}
_AFX_INLINE void PASCAL CMyObject2::operator delete(void* p, void*)
{
	::operator delete(p);
}
_AFX_INLINE void* PASCAL CMyObject2::operator new(size_t nSize)
{
	return ::operator new(nSize);
}
// _DEBUG versions in objcore.cpp
#ifdef _AFXDLL
_AFX_INLINE void CMyObject2::AssertValid() const
{ /* no asserts in release builds */
}
_AFX_INLINE void CMyObject2::Dump(CDumpContext&) const
{ /* no dumping in release builds */
}
#endif //_AFXDLL
#endif //!_DEBUG
_AFX_INLINE const CMyObject2* AFX_CDECL AfxDynamicDownCast(CRuntimeClass* pClass, const CMyObject2* pObject)
{
	return (const CMyObject2*)AfxDynamicDownCast(pClass, (CMyObject2*)pObject);
}
#ifdef _DEBUG
_AFX_INLINE const CMyObject2* AFX_CDECL AfxStaticDownCast(CRuntimeClass* pClass, const CMyObject2* pObject)
{
	return (const CMyObject2*)AfxStaticDownCast(pClass, (CMyObject2*)pObject);
}
#endif
...
{ }
_AFX_INLINE CArchive& AFXAPI operator<<(CArchive& ar, const CMyObject2* pOb)
{
	ar.WriteObject(pOb); return ar;
}
_AFX_INLINE CArchive& AFXAPI operator>>(CArchive& ar, CMyObject2*& pOb)
{
