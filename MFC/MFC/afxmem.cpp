...
void* PASCAL CMyObject::operator new(size_t nSize)
{
	return ::operator new(nSize, _AFX_CLIENT_BLOCK, NULL, 0);
}

void PASCAL CMyObject::operator delete(void* p)
{
	_free_dbg(p, _AFX_CLIENT_BLOCK);
}

void PASCAL CMyObject::operator delete(void* p, void*)
{
	_free_dbg(p, _AFX_CLIENT_BLOCK);
}
...
void* PASCAL
CMyObject::operator new(size_t nSize, LPCSTR lpszFileName, int nLine)
{
	return ::operator new(nSize, _AFX_CLIENT_BLOCK, lpszFileName, nLine);
}

void PASCAL
CMyObject::operator delete(void *pObject, LPCSTR /* lpszFileName */,
	int /* nLine */)
{
...
AFX_STATIC void _AfxDoForAllObjectsProxy(void* pObject, void* pContext)
{
	...
	(*p->m_pfn)((CMyObject*)pObject, p->m_pContext);
}

void AFXAPI
AfxDoForAllObjects(void (AFX_CDECL *pfn)(CMyObject*, void*), void* pContext)
{
	if (pfn == NULL)
	{
