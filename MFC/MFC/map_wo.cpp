...
BOOL CMapWordToOb::Lookup(WORD key, CMyObject*& rValue) const
{
	ASSERT_VALID(this);
...
CMyObject*& CMapWordToOb::operator[](WORD key)
{
	ASSERT_VALID(this);
...
void CMapWordToOb::GetNextAssoc(POSITION& rNextPosition,
	WORD& rKey, CMyObject*& rValue) const
{
	ASSERT_VALID(this);
...
IMPLEMENT_SERIAL(CMapWordToOb, CMyObject, 0)
