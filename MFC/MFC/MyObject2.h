...
#ifndef __MYOBJECT2_H__
#define __MYOBJECT2_H__
...
class CMyObject2;                        // the root of all objects classes
...
void AFXAPI AfxAssertValidObject(const CMyObject2* pOb,
	LPCSTR lpszFileName, int nLine);
void AFXAPI AfxDump(const CMyObject2* pOb); // Dump an object from CodeView
...
//	CMyObject2* (PASCAL* m_pfnCreateObject)(); // NULL => abstract class
//#ifdef _AFXDLL
...
//
//	// Operations
//	CMyObject2* CreateObject();
//	BOOL IsDerivedFrom(const CRuntimeClass* pBaseClass) const;
//
//	// dynamic name lookup and creation
//	static CRuntimeClass* PASCAL FromName(LPCSTR lpszClassName);
//	static CRuntimeClass* PASCAL FromName(LPCWSTR lpszClassName);
//	static CMyObject2* PASCAL CreateObject(LPCSTR lpszClassName);
//	static CMyObject2* PASCAL CreateObject(LPCWSTR lpszClassName);
//
//	// Implementation
...
/*============================================================================*/
// class CMyObject2 is the root of all compliant objects

class AFX_NOVTABLE CMyObject2
{
public:

	// Object model (types, destruction, allocation)
	virtual CRuntimeClass* GetRuntimeClass() const;
	virtual ~CMyObject2() = 0;  // virtual destructors are necessary
...
protected:
	CMyObject2();
private:
	CMyObject2(const CMyObject2& objectSrc);              // no implementation
	void operator=(const CMyObject2& objectSrc);       // no implementation
...
public:
	...
	// Implementation
public:
	static const CRuntimeClass classCMyObject2;
#ifdef _AFXDLL
...
const CMyObject2* AFX_CDECL AfxDynamicDownCast(CRuntimeClass* pClass, const CMyObject2* pObject);
CMyObject2* AFX_CDECL AfxDynamicDownCast(CRuntimeClass* pClass, CMyObject2* pObject);
#define DYNAMIC_DOWNCAST(class_name, object) \
	(class_name*)AfxDynamicDownCast(RUNTIME_CLASS(class_name), object)

#ifdef _DEBUG
const CMyObject2* AFX_CDECL AfxStaticDownCast(CRuntimeClass* pClass, const CMyObject2* pObject);
CMyObject2* AFX_CDECL AfxStaticDownCast(CRuntimeClass* pClass, CMyObject2* pObject);
...
//	static CMyObject2* PASCAL CreateObject();
...
//	CMyObject2* PASCAL class_name::CreateObject() \
...
//class AFX_NOVTABLE CException : public CMyObject2
//{
...
//class CFileFind : public CMyObject2
//{
//public:
//	CFileFind();
//
...
//		objectBlock,  // contains a CMyObject2 derived class object
...
void AFXAPI AfxDoForAllObjects(void (AFX_CDECL *pfn)(CMyObject2* pObject, void* pContext),
	void* pContext);
...
/*============================================================================*/
// Archives for serializing CMyObject2 data
...
//
//	CFile* GetFile() const;
//	UINT GetObjectSchema(); // only valid when reading a CMyObject2*
...
//	friend CArchive& AFXAPI operator<<(CArchive& ar, const CMyObject2* pOb);
//
//	friend CArchive& AFXAPI operator>>(CArchive& ar, CMyObject2*& pOb);
//	friend CArchive& AFXAPI operator>>(CArchive& ar, const CMyObject2*& pOb);
//
...
//
//	// object read/write
//	CMyObject2* ReadObject(const CRuntimeClass* pClass);
//	void WriteObject(const CMyObject2* pOb);
//	// advanced object mapping (used for forced references)
//	void MapObject(const CMyObject2* pOb);
//
...
//	BYTE* m_lpBufStart;
//
//	// array/map for CMyObject2* and CRuntimeClass* load/store
//	UINT m_nMapCount;
//	union
//	{
...
//	CDumpContext& operator<<(const CMyObject2* pOb);
//	CDumpContext& operator<<(const CMyObject2& ob);
