...
BOOL CMapStringToOb::Lookup(LPCTSTR key, CMyObject*& rValue) const
{
	ASSERT_VALID(this);
...
CMyObject*& CMapStringToOb::operator[](LPCTSTR key)
{
	ASSERT_VALID(this);
...
void CMapStringToOb::GetNextAssoc(POSITION& rNextPosition,
	CString& rKey, CMyObject*& rValue) const
{
	ASSERT_VALID(this);
...
IMPLEMENT_SERIAL(CMapStringToOb, CMyObject, 0)
